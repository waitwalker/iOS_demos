...
public class NetworkManager: NSObject {
    ...
    typealias MTTResponse<T> = (T)->Void
    ...
    // 全局网络状态
    var networkStatus: NetworkReachabilityManager.NetworkReachabilityStatus = .notReachable
    ...
    /// get请求方法
    func getRequest(_ convertible: URLConvertible,
    ...
    /// post请求方法
    func postRequest(_ convertible: URLConvertible,
                    parameters: Parameters? = nil,
                    networkResponse: @escaping MTTResponse<BaseModel>) -> Void {
    ...
    /// 基类请求方法
    func baseRequest(_ convertible: URLConvertible,
                     apiType: String,
    ...
    /// 将字典key=value格式拼接
    func mapToQuery(_ parameters: [String : Any]) -> String {
        var list: [String] = []
